  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
        ...
        <section className="bg-gradient-to-b from-gray-100 to-white">
          <div className="max-w-6xl px-4 mx-auto sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <iframe
                src="https://tally.so/embed/npeL8y?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
                className="w-[200px]lg:w-[400px] h-[200px]  flex items-center justify-center mx-auto"
      ...
      <main className="flex-grow">
        {/* <iframe
          src="https://tally.so/embed/npeL8y?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1"
          className="w-[400px] h-[200px] mt-80 flex items-center justify-center mx-auto"
          title="Joined Waiting List "
        ></iframe> */}
      </main>
    </div>
