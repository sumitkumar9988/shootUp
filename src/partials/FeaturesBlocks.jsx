...
function FeaturesBlocks() {
  return (
    <section className="relative py-12 mt-20 bg-gray-900">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-white">Let us find them for you</h2>
            <p className="text-xl text-gray-200">
              We specialize in helping to setup affiliate program and scale. We
              Help find exciting customers for your brand and work with
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-lg shadow-xl">
              <svg
